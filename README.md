...
**Test suite (608 tests, 602 passing + 6 skipped):**
...
|`test_ci_config.py`              |3    |Lint toolchain pin: `.ruff-version` is the single source of truth, CI installs from it, the pre-commit hook warns on version skew|
